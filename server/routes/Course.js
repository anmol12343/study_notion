...
router.post("/addSection", auth, isInstructor,  createSection)
// Update a Section
router.post("/updateSection", auth, isInstructor, isDemo, updateSection)
// Delete a Section
router.post("/deleteSection", auth, isInstructor,isDemo, deleteSection)
// Edit Sub Section
router.post("/updateSubSection", auth, isInstructor,isDemo, updateSubSection)
// Delete Sub Section
router.post("/deleteSubSection", auth, isInstructor,isDemo, deleteSubSection)
// Add a Sub Section to a Section
...
router.post("/updateCourseProgress", auth, isStudent,isDemo, markLectureAsComplete);
