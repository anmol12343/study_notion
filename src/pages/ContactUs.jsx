        ...
        <div className='lg:w-[40%]'>
            <div className='flex flex-col gap-6 rounded-xl bg-richblack-800 p-4 lg:p-6'>
                <div className='flex flex-col gap-[2px] p-3 text-sm text-richblack-200'>
                    ...
                    <p className='font-semibold'>edtech0014532@gmail.com</p>
                </div>
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
                    ...
                    <p className='font-semibold'>Anmol Pandey 1st Block 1st Cross,Noida, Delhi-14092000</p>
                </div>
                <div className="flex flex-col gap-[2px] p-3 text-sm text-richblack-200">
                    <div className='flex flex-row items-center gap-3'>
                ...
                <p className='font-medium'>Mon - Fri 8 Am to 7 Pm</p>
                <p className='font-semibold'>+91 9999 999 999</p>
                </div>
            </div>
        </div>
